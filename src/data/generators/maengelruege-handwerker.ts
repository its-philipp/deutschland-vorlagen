...
{{absenderName}}`,
  ...
  explainer: {
    ...
    legal:
      'Der Unternehmer schuldet ein mangelfreies Werk (§ 633 BGB). Liegt ein Mangel vor, hat der Besteller zunächst grundsätzlich Anspruch auf Nacherfüllung (§ 634 Nr. 1, § 635 BGB); weitergehende Rechte wie Selbstvornahme, Minderung, Rücktritt oder Schadensersatz kommen in der Regel erst in Betracht, wenn eine dafür gesetzte angemessene Frist erfolglos abgelaufen ist, oder ohne Frist, wenn die Nacherfüllung fehlgeschlagen, ernsthaft verweigert oder unzumutbar ist (§ 634 Nr. 2–4 BGB). Bei der Nacherfüllung selbst entscheidet der Unternehmer, ob er nachbessert oder neu herstellt (§ 635 Abs. 1 BGB). Entscheidend für Ihre Beweislage ist der Zeitpunkt: Solange Sie das Werk nicht abgenommen haben, muss der Unternehmer beweisen, dass er mangelfrei geleistet hat. Mit der Abnahme kehrt sich das um – wer eine Leistung als Erfüllung annimmt, trägt danach die Beweislast dafür, dass sie mangelhaft oder unvollständig war (§ 363 BGB). Rügen Sie erkennbare Mängel deshalb vor der Abnahme oder behalten Sie sich Ihre Rechte bei der Abnahme ausdrücklich vor.',
  },
  faq: [
    {
