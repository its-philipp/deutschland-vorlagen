...
const guide: GuideConfig = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Für Sie als Empfänger einer Erhöhung gibt es aber einen zweiten, schnelleren Weg, und für ihn gilt der Vorbehalt der Mindestversicherungsdauer nicht: Erhöht der Versicherer die Prämie auf Grund einer Anpassungsklausel, können Sie für die betroffene Person <strong>innerhalb von zwei Monaten nach Zugang der Mitteilung</strong> kündigen, und zwar zu dem Zeitpunkt, zu dem die Erhöhung wirksam werden soll (§ 205 Abs. 4 VVG). Wer diese zwei Monate verstreichen lässt, ist wieder auf das Jahresende verwiesen.',
  ...
  faq: [
    ...
    },
    {
      ...
      a: 'Nach einer Erhöhung ja, aber nur innerhalb von zwei Monaten nach Zugang der Mitteilung und nur zum Zeitpunkt, zu dem die Erhöhung wirksam wird (§ 205 Abs. 4 VVG); eine laufende Mindestversicherungsdauer steht diesem Sonderkündigungsrecht nicht entgegen. Ohne Erhöhung bleibt die Kündigung zum Jahresende mit drei Monaten Frist, und die gilt nur „vorbehaltlich einer vereinbarten Mindestversicherungsdauer“ (§ 205 Abs. 1 VVG). In beiden Fällen gilt die Versicherungspflicht: Ohne nachgewiesenen Nachfolgeschutz läuft die Kündigung der Krankheitskostenversicherung ins Leere (§ 205 Abs. 6 VVG). Klären Sie deshalb zuerst § 204 VVG.',
    },
  ],
